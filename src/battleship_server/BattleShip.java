...
import connection.ChatSocketServer;
import connection.GameSocketServer;
...
public class BattleShip extends JFrame {
    ...
    public static GameSocketServer server = new GameSocketServer();
    public static ChatSocketServer server_chat = new ChatSocketServer();
